...
1. Sign into the Ambiguous workspace in your recording browser. The cloud
...
One customer problem can leave weak signals across CRM, mail, tasks, calendar,
and chat. Three narrow lanes inspect separate slices. The Desk merges findings,
then every proposed action crosses a visible gate:
...
Exact live message ids and evidence limits are in
[`LIVE_ROUND_REPORT.md`](LIVE_ROUND_REPORT.md). Judge answers are in
[`demo/judge_qa.md`](demo/judge_qa.md).
